...
_crate5 = createVehicle ["USVehicleBox",[(_coords select 0) - 1, _coords select 1,0],[], 0, "CAN_COLLIDE"];
[_crate5] execVM "\z\addons\dayz_server\missions\misc\fillBoxesM.sqf";
_crate5 setVariable ["Sarge",1,true];

_crate6 = createVehicle ["USLaunchersBox",[(_coords select 0) - 3, _coords select 1,0],[], 0, "CAN_COLLIDE"];
